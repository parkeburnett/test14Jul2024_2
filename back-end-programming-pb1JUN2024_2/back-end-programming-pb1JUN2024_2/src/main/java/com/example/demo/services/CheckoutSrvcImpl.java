...
@Service
public class CheckoutSrvcImpl extends CheckoutSrvc {

    @Autowired
    private com.vacationbookings.Vacation.Bookings.dao.CartRepository cartRepository;
    ...
    public CheckoutSrvcImpl(com.vacationbookings.Vacation.Bookings.dao.CartRepository cartRepository, CartItemRepository cartItemRepository){
